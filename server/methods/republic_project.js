/**
 * Created by dauletkaliuly on 12/4/14.
 */
Meteor.methods({
    addRepublicProjectResult: function(resultAttributes) {
        if (!Meteor.user())
        ...
        var recordWithSameResult = RepublicProject.findOne({studentId:resultAttributes.studentId,academicYear:resultAttributes.academicYear});
        ...
        {
            resultId = RepublicProject.insert(resultAttributes);
            return resultId;
        }
        else
