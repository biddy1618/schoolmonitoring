/**
 * Created by dauletkaliuly on 12/1/14.
 */
Meteor.methods({
   addRepublicOlympiadResult: function(resultAttributes) {
      if (!Meteor.user())
      ...
      var recordWithSameResult = RepublicOlympiad.findOne({studentId:resultAttributes.studentId,academicYear:resultAttributes.academicYear});
      ...
      {
         resultId = RepublicOlympiad.insert(resultAttributes);
         return resultId;
      }
      else
