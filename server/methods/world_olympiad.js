 ...
 */
Meteor.methods({
    addWorldOlympiadResult: function(resultAttributes) {
        if (!Meteor.user())
        ...
        var recordWithSameResult = WorldOlympiad.findOne({studentId:resultAttributes.studentId,academicYear:resultAttributes.academicYear});
        ...
        {
            resultId = WorldOlympiad.insert(resultAttributes);
            return resultId;
        }
        else
