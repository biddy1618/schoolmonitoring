 ...
 */
Meteor.methods({
    addRegionalOlympiadResult: function(resultAttributes) {
        if (!Meteor.user())
        ...
        var recordWithSameResult = RegionalOlympiad.findOne({studentId:resultAttributes.studentId,academicYear:resultAttributes.academicYear});
        ...
        {
            resultId = RegionalOlympiad.insert(resultAttributes);
            return resultId;
        }
        else
